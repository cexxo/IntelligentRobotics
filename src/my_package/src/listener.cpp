...
typedef actionlib::SimpleActionClient<my_package::my_actionAction> actionClient;
...
void feedbackCallback(const my_package::my_actionFeedbackConstPtr& feedback){
	ROS_INFO("battery charge: %d", feedback->currentCharge);
}
